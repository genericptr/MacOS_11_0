...
{$define FRAMEWORK_LOADED_IMAGECAPTURECORE}
...
{$include imagecapturecore/UndefinedTypes.inc}

{$define TYPES}
{$include imagecapturecore/Sources.inc}
{$undef TYPES}
...
{$include imagecapturecore/InlineFunctions.inc}
