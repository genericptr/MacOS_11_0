...
{$define FRAMEWORK_LOADED_USERNOTIFICATIONSUI}
...
{$include usernotificationsui/UndefinedTypes.inc}

{$define TYPES}
{$include usernotificationsui/Sources.inc}
{$undef TYPES}
...
{$include usernotificationsui/InlineFunctions.inc}
