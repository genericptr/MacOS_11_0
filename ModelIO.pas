...
{$define FRAMEWORK_LOADED_ModelIO}
...
{$include modelio/UndefinedTypes.inc}

{$define TYPES}
{$include modelio/Sources.inc}
{$undef TYPES}
...
{$include modelio/InlineFunctions.inc}
