...
{$define FRAMEWORK_LOADED_COREHAPTICS}
...
{$include corehaptics/UndefinedTypes.inc}

{$define TYPES}
{$include corehaptics/Sources.inc}
{$undef TYPES}
...
{$include corehaptics/InlineFunctions.inc}
