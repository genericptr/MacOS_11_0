...
{$define FRAMEWORK_LOADED_SENSORKIT}
...
{$include sensorkit/UndefinedTypes.inc}

{$define TYPES}
{$include sensorkit/Sources.inc}
{$undef TYPES}
...
{$include sensorkit/InlineFunctions.inc}
