...
{$define FRAMEWORK_LOADED_CONTACTS}
...
{$include contacts/UndefinedTypes.inc}

{$define TYPES}
{$include contacts/Sources.inc}
{$undef TYPES}
...
{$include contacts/InlineFunctions.inc}
