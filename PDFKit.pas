...
{$define FRAMEWORK_LOADED_PDFKIT}
...
{$include pdfkit/UndefinedTypes.inc}

{$define TYPES}
{$include pdfkit/Sources.inc}
{$undef TYPES}
...
{$include pdfkit/InlineFunctions.inc}
