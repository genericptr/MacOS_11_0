...
{$define FRAMEWORK_LOADED_REPLAYKIT}
...
{$include replaykit/UndefinedTypes.inc}

{$define TYPES}
{$include replaykit/Sources.inc}
{$undef TYPES}
...
{$include replaykit/InlineFunctions.inc}
