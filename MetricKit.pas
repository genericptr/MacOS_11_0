...
{$define FRAMEWORK_LOADED_METRICKIT}
...
{$include metrickit/UndefinedTypes.inc}

{$define TYPES}
{$include metrickit/Sources.inc}
{$undef TYPES}
...
{$include metrickit/InlineFunctions.inc}
