...
type
  ...
  NSFileProviderService = objcclass external;
  NSFileSecurity = objcclass external;
  ...
  NSListFormatter = objcclass external;
  ...
  NSOrderedCollectionChange = objcclass external;
  NSOrderedCollectionDifference = objcclass external;
  ...
  NSRelativeDateTimeFormatter = objcclass external;
  ...
  NSSecureUnarchiveFromDataTransformer = objcclass external;
  ...
  NSURLSessionWebSocketMessage = objcclass external;
  NSURLSessionWebSocketTask = objcclass external;
  ...
  NSUnitInformationStorage = objcclass external;
  ...
  NSItemProviderReadingProtocol = objcprotocol external name 'NSItemProviderReading';
  NSItemProviderWritingProtocol = objcprotocol external name 'NSItemProviderWriting';
  ...
  NSURLSessionWebSocketDelegateProtocol = objcprotocol external name 'NSURLSessionWebSocketDelegate';
