...
{$define FRAMEWORK_LOADED_CONTACTSUI}
...
{$include contactsui/UndefinedTypes.inc}

{$define TYPES}
{$include contactsui/Sources.inc}
{$undef TYPES}
...
{$include contactsui/InlineFunctions.inc}
