...
{$define FRAMEWORK_LOADED_PRINTCORE}
...
{$include printcore/UndefinedTypes.inc}

{$define TYPES}
{$include printcore/Sources.inc}
{$undef TYPES}
...
{$include printcore/InlineFunctions.inc}
