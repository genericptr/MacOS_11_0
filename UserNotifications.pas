...
{$define FRAMEWORK_LOADED_USERNOTIFICATIONS}
...
{$include usernotifications/UndefinedTypes.inc}

{$define TYPES}
{$include usernotifications/Sources.inc}
{$undef TYPES}
...
{$include usernotifications/InlineFunctions.inc}
