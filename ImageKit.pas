...
{$define FRAMEWORK_LOADED_IMAGEKIT}
...
{$include imagekit/UndefinedTypes.inc}

{$define TYPES}
{$include imagekit/Sources.inc}
{$undef TYPES}
...
{$include imagekit/InlineFunctions.inc}
