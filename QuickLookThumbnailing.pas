...
{$define FRAMEWORK_LOADED_QUICKLOOKTHUMBNAILING}
...
{$include quicklookthumbnailing/UndefinedTypes.inc}

{$define TYPES}
{$include quicklookthumbnailing/Sources.inc}
{$undef TYPES}
...
{$include quicklookthumbnailing/InlineFunctions.inc}
