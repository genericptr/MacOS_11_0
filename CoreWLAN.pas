...
{$define FRAMEWORK_LOADED_COREWLAN}
...
{$include corewlan/UndefinedTypes.inc}

{$define TYPES}
{$include corewlan/Sources.inc}
{$undef TYPES}
...
{$include corewlan/InlineFunctions.inc}
