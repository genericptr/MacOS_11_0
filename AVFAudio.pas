...
{$define FRAMEWORK_LOADED_AVFAUDIO}
...
{$include avfaudio/UndefinedTypes.inc}

{$define TYPES}
{$include avfaudio/Sources.inc}
{$undef TYPES}
...
{$include avfaudio/InlineFunctions.inc}
