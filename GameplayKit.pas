...
{$define FRAMEWORK_LOADED_GAMEPLAYKIT}
...
{$include gameplaykit/UndefinedTypes.inc}

{$define TYPES}
{$include gameplaykit/Sources.inc}
{$undef TYPES}
...
{$include gameplaykit/InlineFunctions.inc}
