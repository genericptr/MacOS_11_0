...
{$define FRAMEWORK_LOADED_COREML}
...
{$include coreml/UndefinedTypes.inc}

{$define TYPES}
{$include coreml/Sources.inc}
{$undef TYPES}
...
{$include coreml/InlineFunctions.inc}
